...
## AIM:
To design and configure a multi-router enterprise network in Cisco Packet Tracer with:

✔ Proper LAN and WAN IP addressing

✔ Router-to-router serial communication

✔ End-to-end connectivity using static or dynamic routing
